...
<body>
    ...
    <div class="page-heading about-page-heading1" id="top">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h2>K I N T A M A N I</h2>
                        <span>Kintamani adalah sebuah kecamatan di Kabupaten Bangli, Provinsi Bali, Indonesia. Kintamani juga merupakan kawasan wisata pemandangan alam di Bali, Indonesia.</span>
                    </div>
                </div>
            </div>
        </div>
